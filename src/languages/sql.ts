...
export const SQL: LanguagePattern[] = [
  ...
  // Data types
  {
    pattern: /(VARCHAR|CHAR|BINARY|VARBINARY|BLOB|TEXT)\(\d+\)/,
    type: "constant.type"
  },
  {
    pattern:
      /(BIT|TINYINT|SMALLINT|MEDIUMINT|INT|INTEGER|BIGINT|DOUBLE)\(\d+\)/,
    type: "constant.type"
  },
  {
    pattern: /(TINYBLOB|TINYTEXT|MEDIUMTEXT|MEDIUMBLOB|LONGTEXT|LONGBLOB)/,
    type: "constant.type"
  },
